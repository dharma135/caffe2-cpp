...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_model_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_InputInfo;
extern PROTOBUF_INTERNAL_EXPORT_protobuf_model_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_OutputInfo;
extern PROTOBUF_INTERNAL_EXPORT_protobuf_model_2eproto ::google::protobuf::internal::SCCInfo<2> scc_info_ModelMeta;
}  // namespace protobuf_model_2eproto
namespace caffe2 {
...
namespace protobuf_model_2eproto {
static void InitDefaultsInputInfo() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_InputInfo =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsInputInfo}, {}};

static void InitDefaultsOutputInfo() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<0> scc_info_OutputInfo =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsOutputInfo}, {}};

static void InitDefaultsModelMeta() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<2> scc_info_ModelMeta =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 2, InitDefaultsModelMeta}, {
      &protobuf_model_2eproto::scc_info_InputInfo.base,
      &protobuf_model_2eproto::scc_info_OutputInfo.base,}};
...
::google::protobuf::internal::SCCInfo<2> scc_info_ModelDef =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 2, InitDefaultsModelDef}, {
      &protobuf_model_2eproto::scc_info_ModelMeta.base,
      &protobuf_caffe2_2fproto_2fcaffe2_2eproto::scc_info_Argument.base,}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_InputInfo.base);
  ::google::protobuf::internal::InitSCC(&scc_info_OutputInfo.base);
  ::google::protobuf::internal::InitSCC(&scc_info_ModelMeta.base);
...
const InputInfo& InputInfo::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_model_2eproto::scc_info_InputInfo.base);
...
const OutputInfo& OutputInfo::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_model_2eproto::scc_info_OutputInfo.base);
  return *internal_default_instance();
}
...
const ModelMeta& ModelMeta::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_model_2eproto::scc_info_ModelMeta.base);
  return *internal_default_instance();
}
...
ModelDef::ModelDef()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_model_2eproto::scc_info_ModelDef.base);
  SharedCtor();
...
const ModelDef& ModelDef::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_model_2eproto::scc_info_ModelDef.base);
  return *internal_default_instance();
}
...
void ModelDef::SerializeWithCachedSizes(
  ...
  if (cached_has_bits & 0x00000004u) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      3, this->_internal_predict(), output);
  }
...
::google::protobuf::uint8* ModelDef::InternalSerializeWithCachedSizesToArray(
  ...
  if (cached_has_bits & 0x00000004u) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        3, this->_internal_predict(), deterministic, target);
  }
...
bool ModelDef::IsInitialized() const {
  if (has_init()) {
    if (!this->init_->IsInitialized()) return false;
  }
  if (has_predict()) {
    if (!this->predict_->IsInitialized()) return false;
  }
  return true;
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::caffe2::InputInfo* Arena::CreateMaybeMessage< ::caffe2::InputInfo >(Arena* arena) {
  return Arena::CreateInternal< ::caffe2::InputInfo >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::caffe2::OutputInfo* Arena::CreateMaybeMessage< ::caffe2::OutputInfo >(Arena* arena) {
  return Arena::CreateInternal< ::caffe2::OutputInfo >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::caffe2::ModelMeta* Arena::CreateMaybeMessage< ::caffe2::ModelMeta >(Arena* arena) {
  return Arena::CreateInternal< ::caffe2::ModelMeta >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::caffe2::ModelDef* Arena::CreateMaybeMessage< ::caffe2::ModelDef >(Arena* arena) {
