...
class InputInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe2.InputInfo) */ {
 public:
  ...
  inline InputInfo* New() const final {
    return CreateMaybeMessage<InputInfo>(NULL);
  }

  InputInfo* New(::google::protobuf::Arena* arena) const final {
...
class OutputInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe2.OutputInfo) */ {
 public:
  ...
  inline OutputInfo* New() const final {
    return CreateMaybeMessage<OutputInfo>(NULL);
  }

  OutputInfo* New(::google::protobuf::Arena* arena) const final {
...
class ModelMeta : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe2.ModelMeta) */ {
 public:
  ...
  inline ModelMeta* New() const final {
    return CreateMaybeMessage<ModelMeta>(NULL);
  }

  ModelMeta* New(::google::protobuf::Arena* arena) const final {
